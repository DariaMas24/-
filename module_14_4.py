...
api = "7254805384:AAGr17HaZHEVwu5Xixd7_iljhGOzCM4-8aU"
bot = Bot(token=api)
...
button_buy = InlineKeyboardButton(text='Духи', callback_data="product_buying")
button_buy2 = InlineKeyboardButton(text='Крем', callback_data="product_buying")
button_buy3 = InlineKeyboardButton(text='Помада', callback_data="product_buying")
button_buy4 = InlineKeyboardButton(text='Тушь', callback_data="product_buying")
